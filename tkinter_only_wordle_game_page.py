...
def fnCheckAttemptNo():
    ...
    # Checking for FORTH attempt ----.
        ...
        if len(greenList) == 5:
            ...
            messagebox.showwarning("Warning", "Incorrcet Answer...")
            tempCount += 1
            Label(wordle_screen, text="Answer Checked.",
...
def wordle_test():
    ...
    submitButton = Button(bottomframe, text="Submit", font="buttonFont",
                          width=10, height=1, bg="blue", fg="white")
