...
from tkinter_wordle_game_main_loagical_program_five_letter import WordleClass
...
def wordle_test():
    ...
    row1e5_entry = Entry(frame1, textvariable=row1e5, width = 2, font = ('Geogia 20'), bg='black', fg='white', justify='center')
    ...
    row2e5_entry = Entry(frame2, textvariable=row2e5, width = 2, font = ('Geogia 20'), bg='black', fg='white', justify='center')
    ...
    row3e5_entry = Entry(frame3, textvariable=row3e5, width = 2, font = ('Geogia 20'), bg='black', fg='white', justify='center')
    ...
    row4e5_entry = Entry(frame4, textvariable=row4e5, width = 2, font = ('Geogia 20'), bg='black', fg='white', justify='center')
    ...
    row5e5_entry = Entry(frame5, textvariable=row5e5, width = 2, font = ('Geogia 20'), bg='black', fg='white', justify='center')
    ...
    row6e5_entry = Entry(frame6, textvariable=row6e5, width = 2, font = ('Geogia 20'), bg='black', fg='white', justify='center')
...
def fnCheckAttemptNo():
    ...
    if tempCount == 1:
        ...
        for i in greenList:
            ...
            if i==5:
                row1e5_entry.configure(disabledbackground="green", state="disabled", disabledforeground="black")
        for i in yellowList:
            if i==1:
            ...
            if i==5:
                row1e5_entry.configure(disabledbackground="yellow", state="disabled", disabledforeground="black")
        for i in greyList:
            if i==1:
            ...
            if i==5:
                row1e5_entry.configure(disabledbackground="grey", state="disabled", disabledforeground="black")
    ...
    #--- For second attempt ----
        ...
        for i in greenList:
            ...
            if i==5:
                row2e5_entry.configure(disabledbackground="green", state="disabled", disabledforeground="black")
        for i in yellowList:
            if i==1:
            ...
            if i==5:
                row2e5_entry.configure(disabledbackground="yellow", state="disabled", disabledforeground="black")
        for i in greyList:
            if i==1:
            ...
            if i==5:
                row2e5_entry.configure(disabledbackground="grey", state="disabled", disabledforeground="black")
        #Checking if answer is correct or not.
        if len(greenList)==5:
            tmpLabelcorrect = Label(wordle_screen, text="Congratulations! Your Answer is CORRECT.", fg="green", font=("calibri", 11))
            tmpLabelcorrect.pack()
    ...
    # ----- For third attempt ------
        ...
        for i in greenList:
            ...
            if i==5:
                row3e5_entry.configure(disabledbackground="green", state="disabled", disabledforeground="black")
        for i in yellowList:
            if i==1:
            ...
            if i==5:
                row3e5_entry.configure(disabledbackground="yellow", state="disabled", disabledforeground="black")
        for i in greyList:
            if i==1:
            ...
            if i==5:
                row3e5_entry.configure(disabledbackground="grey", state="disabled", disabledforeground="black")
        #Checking if answer is correct or not.
        if len(greenList)==5:
            tmpLabelcorrect = Label(wordle_screen, text="Congratulations! Your Answer is CORRECT.", fg="green", font=("calibri", 11))
            tmpLabelcorrect.pack()
    ...
    #Checking for FORTH attempt ----.
        ...
        for i in greenList:
            ...
            if i==5:
                row4e5_entry.configure(disabledbackground="green", state="disabled", disabledforeground="black")
        for i in yellowList:
            if i==1:
            ...
            if i==5:
                row4e5_entry.configure(disabledbackground="yellow", state="disabled", disabledforeground="black")
        for i in greyList:
            if i==1:
            ...
            if i==5:
                row4e5_entry.configure(disabledbackground="grey", state="disabled", disabledforeground="black")
        #Checking if answer is correct or not.
        if len(greenList)==5:
            tmpLabelcorrect = Label(wordle_screen, text="Congratulations! Your Answer is CORRECT.", fg="green", font=("calibri", 11))
            tmpLabelcorrect.pack()
    ...
    #Checking for FIFTH attempt ----.
        ...
        for i in greenList:
            ...
            if i==5:
                row5e5_entry.configure(disabledbackground="green", state="disabled", disabledforeground="black")
        for i in yellowList:
            if i==1:
            ...
            if i==5:
                row5e5_entry.configure(disabledbackground="yellow", state="disabled", disabledforeground="black")
        for i in greyList:
            if i==1:
            ...
            if i==5:
                row5e5_entry.configure(disabledbackground="grey", state="disabled", disabledforeground="black")
        #Checking if answer is correct or not.
        if len(greenList)==5:
            tmpLabelcorrect = Label(wordle_screen, text="Congratulations! Your Answer is CORRECT.", fg="green", font=("calibri", 11))
            tmpLabelcorrect.pack()
    ...
    #Checking for SIXTH attempt ----.
        ...
        for i in greenList:
            ...
            if i==5:
                row6e5_entry.configure(disabledbackground="green", state="disabled", disabledforeground="black")
        for i in yellowList:
            if i==1:
            ...
            if i==5:
                row6e5_entry.configure(disabledbackground="yellow", state="disabled", disabledforeground="black")
        for i in greyList:
            if i==1:
            ...
            if i==5:
                row6e5_entry.configure(disabledbackground="grey", state="disabled", disabledforeground="black")
        #Checking if answer is correct or not.
        if len(greenList)==5:
            tmpLabelcorrect = Label(wordle_screen, text="Congratulations! Your Answer is CORRECT.", fg="green", font=("calibri", 11))
            tmpLabelcorrect.pack()
